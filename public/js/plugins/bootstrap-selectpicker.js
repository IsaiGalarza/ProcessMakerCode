        ...
        Selectpicker.prototype = {
            ...
            createLi: function() {
                ...
                var generateText = function(options) {
                    ...
                    if (options.optionContent) {
                        ...
                        if (options.optionIcon) {
                            ...
                            optionIconElement = elementTemplates.span.cloneNode(
                                false
                            );
                        ...
                        if (options.optionSubtext) {
                            optionSubtextElement = elementTemplates.subtext.cloneNode(
                                false
                            );
                ...
                var generateLabel = function(options) {
                    var labelTextElement = elementTemplates.text.cloneNode(
                            false
                        ),
                        labelSubtextElement,
                        labelIconElement;
                    ...
                    if (options.labelIcon) {
                        ...
                        labelIconElement = elementTemplates.span.cloneNode(
                            false
                        );
                    ...
                    if (options.labelSubtext) {
                        labelSubtextElement = elementTemplates.subtext.cloneNode(
                            false
                        );
            ...
            render: function() {
                ...
                if (
                    ...
                    if (
                        ...
                        var totalCount = this.selectpicker.view
                                .availableOptionsCount,
                            tr8nText =
            ...
            setOptionStatus: function() {
                ...
                if (
                    ...
                    for (
                        ...
                        if (option) {
                            var liIndex = this.selectpicker.main.map.newIndex[
                                    index
                                ],
                ...
                this.$searchbox.on("input propertychange", function() {
                    ...
                    if (searchValue) {
                        ...
                        if (!searchMatch.length) {
                            ...
                            no_results.innerHTML = that.options.noneResultsText.replace(
                                "{0}",
